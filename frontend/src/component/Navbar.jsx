...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between w-full px-3 sm:px-6 py-2 sm:py-3 bg-white shadow min-h-[56px] sm:min-h-[64px]">
      {/* Left: Logo and Brand */}
      <div className="flex items-center space-x-2 sm:space-x-3">
        ...
        <img
          src="/brain.png"
          alt="Logo"
          className="h-10 w-10 sm:h-16 sm:w-16 rounded-full object-contain"
        />
      ...
      <div className="flex items-center space-x-2 sm:space-x-4">
        ...
        <button className="p-2 rounded-full hover:bg-gray-100">
          <IoMdNotificationsOutline className="h-6 w-6 sm:h-7 sm:w-7 text-gray-500" />
        </button>
        {/* User/Profile/Login */}
        <div className="relative group flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 bg-blue-100 rounded-full cursor-pointer">
          {isSignedIn ? (
